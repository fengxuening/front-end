<template>
  <div class="app-container">
    ...
    <a-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <a-table-column align="center" label="角色" prop="roleName" width="150"></a-table-column>
      <a-table-column align="center" label="用户">
        <template slot-scope="scope">
      ...
      <a-table-column align="center" label="菜单&权限" width="420">
        <template slot-scope="scope">
      ...
      <a-table-column align="center" label="管理" width="220" v-if="hasPerm('role:update') ||hasPerm('role:delete') ">
        <template slot-scope="scope">
